...
export default function Register() {
  ...
  return (
    <div className="w-full min-h-screen bg-background flex items-center justify-center font-sans py-4 sm:py-6 md:py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-[1200px] min-h-[580px] bg-white flex flex-col md:flex-row overflow-hidden rounded-2xl shadow-[0px_4px_40px_rgba(0,0,0,0.06)] border border-outline-variant/30">
        ...
        {/* Right Side: Form */}
        <div className="w-full md:w-1/2 flex flex-col justify-center py-6 px-6 sm:px-10 lg:px-16 bg-white">
          <div className="w-full max-w-[400px] mx-auto">
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-on-surface-variant">Get started today for free.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-outline-variant/40 rounded-xl py-1.5 pl-10 pr-4 text-on-surface text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-outline-variant/40 rounded-xl py-1.5 pl-10 pr-10 text-on-surface text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none"
                  />
                  <button 
                    type="button"
              ...
              <div>
                <label className="block text-xs font-semibold text-on-surface-variant mb-1.5" htmlFor="confirmPassword">
                  Confirm Password
                </label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant/60 flex items-center">
              ...
              <div className="flex items-start mt-2">
                <input 
                  ...
                  className="mt-1 w-4 h-4 rounded text-primary border-outline-variant/60 focus:ring-primary bg-slate-50 cursor-pointer"
                />
                <label className="ml-2 block text-xs text-on-surface-variant cursor-pointer leading-tight" htmlFor="agreeTerms">
            ...
            <div className="mt-4 mb-3 flex items-center">
              ...
              <span className="mx-4 text-[10px] font-bold text-on-surface-variant/60 uppercase tracking-widest">Or sign up with</span>
              <div className="flex-grow border-t border-outline-variant/30"></div>
            </div>

            {/* Social Login */}
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 bg-white border border-outline-variant/40 hover:bg-slate-50 text-on-surface font-semibold text-xs py-1.5 px-3 rounded-xl transition-all shadow-sm cursor-pointer active:scale-95">
